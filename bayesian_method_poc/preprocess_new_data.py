...
# Load data
input_file = Path("E:/Personal/GitHub/good-signal/bayesian_method_poc/ETHUSDT_1min.csv")
output_file = Path("E:/Personal/GitHub/good-signal/bayesian_method_poc/ETHUSDT_1min_with_imbalance.csv")
